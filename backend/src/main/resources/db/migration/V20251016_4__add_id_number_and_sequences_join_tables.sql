...
/
BEGIN PR_ADD_UNIQUE_IF_MISSING('AGENTE_COMARCA','UK_AGCO01','AGENTE_ID, COMARCA_ID'); EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN PR_ADD_UNIQUE_IF_MISSING('AGENTE_AREA_ATUACAO','UK_AGAA01','AGENTE_ID, AREA_ATUACAO_ID'); EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN PR_ADD_UNIQUE_IF_MISSING('AUTO_INFRACAO_TESTEMUNHA','UK_AIT01','AUTO_INFRACAO_ID, TESTEMUNHA_ID'); EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN
  BEGIN EXECUTE IMMEDIATE 'CREATE INDEX I_FK_AGCO_AGVO01 ON AGENTE_COMARCA (AGENTE_ID)'; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN EXECUTE IMMEDIATE 'CREATE INDEX I_FK_AGCO_COMA01 ON AGENTE_COMARCA (COMARCA_ID)'; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN EXECUTE IMMEDIATE 'CREATE INDEX I_FK_AGAA_AGVO01 ON AGENTE_AREA_ATUACAO (AGENTE_ID)'; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN EXECUTE IMMEDIATE 'CREATE INDEX I_FK_AGAA_ARAT01 ON AGENTE_AREA_ATUACAO (AREA_ATUACAO_ID)'; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN EXECUTE IMMEDIATE 'CREATE INDEX I_FK_AIT_AUTO01 ON AUTO_INFRACAO_TESTEMUNHA (AUTO_INFRACAO_ID)'; EXCEPTION WHEN OTHERS THEN NULL; END;
